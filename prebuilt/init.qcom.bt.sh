...
start_hciattach ()
{
  ...
  #brcm_patchram_plus -d --enable_hci --enable_lpm --baudrate 3000000 --patchram /etc/firmware/BCM4330B1_002.001.003.0221.0228.hcd /dev/ttyHS0&
  hciattach_pid=$!
...
/system/bin/brcm_patchram_plus --patchram /system/etc/firmware/BCM4330B1_002.001.003.0221.0228.hcd /dev/ttyHS0
